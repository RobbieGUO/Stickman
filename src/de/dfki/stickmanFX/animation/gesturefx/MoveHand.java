 ...
 *
 */
public class MoveHand extends AnimationFX {

    public MoveHand() {
        mAnimType = ANIMTYPE.Gesture;
    }

    public MoveHand(StickmanFX sm, int duration, boolean block) {
    ...
    public void playAnimation() {
        ...
        mAnimationPartFX.add(new AnimationContentFX(mStickmanFX.mLeftShoulderFX, "rotate", -rotationUnit));
